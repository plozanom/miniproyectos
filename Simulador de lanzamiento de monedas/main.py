"""Mini-Proyecto: Simulador de Lanzamiento de Monedas:
Pide al usuario cuántas veces quiere lanzar una moneda.
Simula los lanzamientos (50% cara, 50% cruz) usando el módulo random .
Cuenta cuántas veces salió cara y cuántas cruz.
Imprime los resultados y el porcentaje de cada uno."""
